...
public class DynamicCountyComparator implements Comparator<County> {
	...
	public int compare(County o1, County o2) {
		...
		double score1 = (double)surveyResult.getPopulationResult()   /	(double)(o1.getPopulationRank())
				      ...
				      + (double)surveyResult.getTemperatureResult()  /	(double)(o1.getTemperatureRank())
				      + (double)surveyResult.getCrimeRateResult()    /	(double)(o1.getCrimeRank())
				      + (double)surveyResult.getUnemploymentResult() /	(double)(o1.getUnemploymentRank())
				      + (double)surveyResult.getStudentResult()      /	(double)(o1.getStudentRank())
				      ;
		
		double score2 = (double)surveyResult.getPopulationResult()   /	(double)(o2.getPopulationRank())
			          ...
			          + (double)surveyResult.getTemperatureResult()  /	(double)(o2.getTemperatureRank())
			          + (double)surveyResult.getCrimeRateResult()    /	(double)(o2.getCrimeRank())
			          + (double)surveyResult.getUnemploymentResult() /	(double)(o2.getUnemploymentRank())
